...
- At **Voronoi Health Analytics**, I'm developing a React/Redux and TypeScript-based image annotation tool to enhance image classification accuracy and aid in machine learning model training.
- Developed a desktop server application using Electron.js, React/Redux, Material UI, Django, and SQLite. This application facilitates the uploading of medical images from hospital servers to the application server and automates sending DICOM files to the image analysis server.
- Routinely reviewing the code of junior developers, providing guidance and improvements to ensure high code quality.

### 🌱 Personal Projects:
- **Gigplus Analytics Mobile Application**
  - **Technologies Used:** Expo, React Native, Firebase (Authentication, Data Store), Git
  - **Description:** Developed a mobile application that helps gig workers boost their income by providing analytics data based on their income and expenses, and showing them the best times and places to work.
